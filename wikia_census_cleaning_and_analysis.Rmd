...
Por último, como hemos podido observar en el caso de la correlación entre visitas a las wikis y número de usuarios activos, quiero resaltar la importancia de que los datos estén limpios, claros, actualizados y sincronizados en la misma fecha, porque de otra manera los análisis, visualizaciones y conclusiones que hagamos pueden ser engañosas o poco fiables.

A pesar de lo anterior, hemos confirmado que para nuestras conclusiones no nos afecta demasiado estos casos extremos puesto que para la gran mayoría de instancias de wikis nuestro dataset la situación es bastante estable y p
